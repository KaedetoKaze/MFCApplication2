...
#ifndef CNPY_ENABLE_ZLIB
#define CNPY_ENABLE_ZLIB 0
#endif
...
cnpy::NpyArray load_the_npz_array(FILE* fp, uint32_t compr_bytes, uint32_t uncompr_bytes) {
    ...
    return array;
#else
    throw std::runtime_error("npz support disabled (CNPY_ENABLE_ZLIB=0)");
#endif
}

cnpy::npz_t cnpy::npz_load(std::string fname) {
#if !CNPY_ENABLE_ZLIB
    throw std::runtime_error("npz_load requires zlib (CNPY_ENABLE_ZLIB=1)");
#else
